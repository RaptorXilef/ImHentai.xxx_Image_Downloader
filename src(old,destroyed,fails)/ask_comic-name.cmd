...
:comicNameInput
  ...
  :chcp1252
    ...
    ::set "comicName_short=%comicName_:~0,99%"
        ...
        IF exist "%savePath%\%dl-theme%\%comicName_%" cls & echo. & echo     Der Name %comicName% ist bereist vergeben! & echo     Bitte wählen Sie einen anderen Namen. & choice /N /C 123 /T 1 /D 1 /M "" >NUL & goto comicNameInput
